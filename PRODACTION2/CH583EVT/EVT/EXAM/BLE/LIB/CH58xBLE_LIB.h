...
/* Tx_POWER define(Accuracy:В±2dBm) */
...
#define GATT_CHAR_USER_DESC_UUID        0xFFFF // Characteristic User Description
#define GATT_CLIENT_CHAR_CFG_UUID       0xFFFF // Client Characteristic Configuration
...
// v5.x
#define TGAP_ADV_TX_POWER                       25  //!< Indicates the maximum power level Range: -127 в‰¤ N в‰¤ +126 Units: dBm.Default 127(Host has no preference).
...
#define SMP_PAIRING_FAILED_DHKEY_CHECK_FAILED   0x0B //!< Indicates to the remote device that the DHKey Check value received doesnпїЅпїЅt match the one calculated by the local device.
...
extern  uint8_t charUserDescUUID[];
 ...
 * It shall not be t he advertising channel packetsпїЅпїЅ Access Address.
